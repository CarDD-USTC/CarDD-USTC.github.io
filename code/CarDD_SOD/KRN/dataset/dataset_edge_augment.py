...
#            self.sal_list = [x.strip() for x in f.readlines()]
    ...
    def __getitem__(self, item):
        ...
        # sal_image, sal_label, sal_edge = generate_scale_label(sal_image, sal_label, sal_edge) # resize会导致后续层input维度为0的错误
        ...
        sample = {'sal_image': sal_image, 'sal_label': sal_label, 'sal_edge': sal_edge, 'sal_saliency': sal_saliency, 'im_name': im_name}
        return sample
