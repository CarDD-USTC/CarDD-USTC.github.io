...
def get_test_info(sal_mode='e'):
    if sal_mode == 'e':
        ...
        image_root = './data/CarDD-TE/Imgs/'
        image_source = './data/CarDD-TE/test.lst'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_folder', type=str, default='/workspace/wangxinkuang/model/saliency_detection/joint')
    ...
    # Train data
    parser.add_argument('--train_root', type=str, default='./data/CarDD/CarDD-TR')
    parser.add_argument('--train_list', type=str, default='./data/CarDD/CarDD-TR/train_pair.lst')
