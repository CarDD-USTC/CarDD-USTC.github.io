...
_C.DATA.WORKERS = 4
_C.DATA.SAVEDIR = '/workspace/wangxinkuang/model/CSNet'
_C.DATA.RESULTDIR = '/workspace/wangxinkuang/result/CSNet'
_C.DATA.PRETRAIN = ''
_C.DATA.RESUME = ''
_C.DATA.IMAGE_H = 224
_C.DATA.IMAGE_W = 224
...
_C.TEST.MODEL_CONFIG = '/workspace/wangxinkuang/code/SOD100K-master/CSNet_training/results/csnet-L-x2_train-CarDD/layer_configs/layer_config_latest.bin'
# # ---------------------------------------------------------------------------- #
# # Solver
# # ---------------------------------------------------------------------------- #
_C.SOLVER = CN()
