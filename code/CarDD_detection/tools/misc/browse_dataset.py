...
def main():
    ...
    for item in dataset:
        ...
        if gt_masks is not None:
            if isinstance(gt_masks, DataContainer):
        ...
        imshow_det_bboxes(
            ...
            bbox_color=('#FFB6C1', '#00a8e1', '#00FF00', '#800080', '#FFFF00', '#e30039'), # change color
            text_color=[(255, 182, 193), (0, 168, 225), (0, 255, 0), (128, 0, 128), (255, 255, 0), (227, 0, 57)],  # change color
            # mask_color=dataset.PALETTE)
            mask_color=('#FFB6C1', '#00a8e1', '#00FF00', '#800080', '#FFFF00', '#e30039')) # change color
